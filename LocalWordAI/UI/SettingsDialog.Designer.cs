...
namespace LocalWordAI.UI
{
    partial class SettingsDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            chkTrackChanges = new CheckBox { Text = "Mặc định dùng Track Changes", Location = new Point(cx, y), AutoSize = true };
            chkConfirmBefore = new CheckBox { Text = "Xác nhận trước khi áp dụng", AutoSize = true };
            txtSkillsDir = new TextBox { Font = new Font("Segoe UI", 8.5f) };
            txtAuthor = new TextBox { Font = new Font("Segoe UI", 8.5f) };

            AddRow("LM Studio URL:", txtBaseUrl);
            AddRow("Model name:", txtModel);
            AddRow("Timeout (giây):", nudTimeout);
            AddRow("Max tokens:", nudMaxTokens);
            AddRow("Temperature:", nudTemperature);
            ...
            AddRow("Thư mục Skills:", txtSkillsDir);
            AddRow("Tên tác giả AI:", txtAuthor);

            btnTest = new Button { Text = "Test kết nối", Location = new Point(10, y), Size = new Size(100, 28), FlatStyle = FlatStyle.Flat };
            ...
            lblModels = new Label { Text = "Model:", Location = new Point(lx, y + 3), AutoSize = true, Visible = false };
            ...
            btnSave = new Button
            {
                Text = "Lưu", Location = new Point(240, y), Size = new Size(80, 30),
                BackColor = Color.FromArgb(37, 99, 235), ForeColor = Color.White, FlatStyle = FlatStyle.Flat
            };
            btnCancel = new Button { Text = "Hủy", Location = new Point(330, y), Size = new Size(80, 30), FlatStyle = FlatStyle.Flat };
